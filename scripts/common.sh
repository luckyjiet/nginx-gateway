...
ensure_runtime_dirs() {
  mkdir -p "$ROOT_DIR/certbot/www" "$ROOT_DIR/certbot/conf" "$OPENCOIN_WEB_ROOT" "$WITTGENS_WEB_ROOT"
}
...
export OPENCOIN_DOMAIN OPENCOIN_CERT_NAME OPENCOIN_CERT_DOMAINS CERT_GROUP_KEYS CERT_GROUP_NAMES
export RWAT_FRONTEND_DOMAIN RWAT_API_DOMAIN RWAT_ADMIN_DOMAIN RWAT_FRONTEND_ROOT
